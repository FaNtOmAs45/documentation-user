...
Note that if your Odoo databas was first created after the update was released, the
...
database is already up-to-date and you can proceed with the :doc:`Configuration <./setup>` step
...
in the :doc:`Configure Amazon Connector in Odoo <./setup>` page.